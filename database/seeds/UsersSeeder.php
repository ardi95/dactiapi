...
class UsersSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$karyawan2->password = bcrypt('rahasia');
		$karyawan2->status = '1';
        $karyawan2->save();
		...
		$karyawan3->password = bcrypt('rahasia');
		$karyawan3->status = '1';
        $karyawan3->save();
		...
		$karyawan4->password = bcrypt('rahasia');
		$karyawan4->status = '1';
        $karyawan4->save();
		...
		$karyawan5->password = bcrypt('rahasia');
		$karyawan5->status = '1';
        $karyawan5->save();
		...
		$karyawan6->password = bcrypt('rahasia');
		$karyawan6->status = '1';
        $karyawan6->save();
		...
		$karyawan7->password = bcrypt('rahasia');
		$karyawan7->status = '1';
        $karyawan7->save();
		...
		$karyawan8->password = bcrypt('rahasia');
		$karyawan8->status = '1';
        $karyawan8->save();
		...
		$karyawan9->password = bcrypt('rahasia');
		$karyawan9->status = '1';
        $karyawan9->save();
		...
		$karyawan10->password = bcrypt('rahasia');
		$karyawan10->status = '1';
        $karyawan10->save();
